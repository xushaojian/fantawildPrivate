...
@Form.create()
export default class ProjectType extends PureComponent{
    state = {
        type:'',
        title:'',
    ...
    handleSubmit=()=>{
        ...
        this.ProjectTypeForm.props.form.validateFields((err, fieldsValue) => {
            if (err) return;
            dispatch({
        ...
        //重置表单    
        this.ProjectTypeForm.props.form.resetFields();
        this.setState({
            projectModalVisible:false,
            selectedRows:[]
        })
    ...
    render(){
        ...
        return (
            <Card >
                 ...
                 okText="确定"
                 cancelText="取消">
                    <ProjectTypeForm type={this.state.type} sysProject={this.state.selectedRows[0]} wrappedComponentRef={(inst)=>{this.ProjectTypeForm=inst;}}></ProjectTypeForm>
                </Modal>
                 <Row >
    ...
    render(){
       ...
       return (
          <Form  layout="horizontal">
             <FormItem label="项目类型ID" {...formItemLayout} style={{display:'none'}}>
                {
            ...
            <FormItem label="类型说明" {...formItemLayout}>
                {
                    getFieldDecorator('TypeInfo',{
                        initialValue:sysProject.TypeInfo==null?null:sysProject.TypeInfo,
                    })(
...
ProjectTypeForm=Form.create({})(ProjectTypeForm);