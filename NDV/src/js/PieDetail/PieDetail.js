...
render() {
    return  <div>
            ...
            <Flex direction='row' style={{ height:'70px',margin:'10px',borderRadius:'10px',backgroundColor:'#FAEBD7' }}>
                ...
                <span style={{ paddingBottom: '10px',color:'#828282'}}>播放总次数</span>
                <span>{this.state.field}</span>
                </Flex>
                <Flex direction='column' justify='center' style={{ width: '25%' }}>
                <span style={{ paddingBottom: '10px',color:'#828282'}}>正常次数</span>
                <span>{this.state.normal}</span>
                </Flex>
                <Flex direction='column' justify='center' style={{ width: '25%' }}>
                <span style={{ paddingBottom: '10px',color:'#828282'}}>异常次数</span>
                <span>{this.state.fault}</span>
                </Flex>
                <Flex direction='column' justify='center' style={{ width: '25%' }}>
                <span style={{ paddingBottom: '10px',color:'#828282'}}>异常率</span>
