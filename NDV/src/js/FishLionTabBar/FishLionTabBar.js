    ...
    return (
      <div style={{ position: 'fixed', height: '100%', width: '100%', top: 0 }}>
        ...
        >
          ...
          <TabBar.Item
            icon={<span className="iconfont icon-touyingyi180" style={{fontSize:'25px'}}></span>}
            selectedIcon={<span className="iconfont icon-touyingyi180" style={{fontSize:'25px'}}></span>}
            title="终端"
            key="terminal" 
            selected={this.state.selectedTab === 'terminal'}
            onPress={() => {
              this.setState({
